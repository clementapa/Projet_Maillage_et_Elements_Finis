...
points.append(model.geo.addPoint(L/1.6 + Lr, l/1.6, 0, h))
points.append(model.geo.addPoint(L/1.6, l/1.6 , 0, h))
...
gmsh.model.addPhysicalGroup(1, [8,9], 2)
...
# Write on disk
gmsh.write("fichier_msh/config_2.msh")
