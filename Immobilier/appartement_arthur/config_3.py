...
points.append(model.geo.addPoint(0, l/1.6 + Lr, 0, h))
points.append(model.geo.addPoint(0, l/1.6, 0, h))
...
gmsh.model.addPhysicalGroup(1, [13,14], 2)
...
# Write on disk
gmsh.write("fichier_msh/config_3.msh")
